...
import com.kevingutierrez.webapp.biblioteca.service.LibroService;
...
public class LibroController {
    ...
    public ResponseEntity<Map<String, String>> agregarLibro(@RequestBody Libro libro){
        ...
        try {
            ...
            response.put("message", "Libro creado!!");
    ...
    public ResponseEntity<Map<String, String>> eliminarLibro(@RequestParam Long id){
        ...
        try {
            ...
            response.put("Message", "Error");
            response.put("err", "Hubo un problema al eliminar el libro");
            return ResponseEntity.badRequest().body(response);
        }
    }
}
